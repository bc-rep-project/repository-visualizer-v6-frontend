    ...
    try {
      ...
      const root = d3.hierarchy<FileNode>(data)
        .sum(d => {
          ...
          } else if (d.type === 'function' || d.type === 'class' || (d.type as 'file' | 'directory' | 'function' | 'class' | 'method') === 'method') {
            return 1;
      ...
      const colorScale = (d: d3.HierarchyRectangularNode<FileNode>) => {
        ...
        if (node.type === 'function' || (node.type as 'file' | 'directory' | 'function' | 'class' | 'method') === 'method') return '#b794f4';
